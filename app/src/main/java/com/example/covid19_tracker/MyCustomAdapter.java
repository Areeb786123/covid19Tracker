...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter(Context context,List<CountryModel> countryModelList) {
        super(context, R.layout.listcoustomitem,countryModelList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listcoustomitem,null,true);
    ...
    public Filter getFilter() {
        final Filter filter =  new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                Affect_Countries.countryModelList = (List<CountryModel>)results.values;
